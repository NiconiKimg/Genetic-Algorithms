...
from src.graficadores import (
    graficar_heatmap_elementos,
    graficar_heatmap_elementos_global,
    graficar_tiempo_vs_n,
    graficar_uso_capacidad,
)


def generar_todas_las_graficas(ruta_csv_especifica: str | None = None) -> None:
    """Genera los gráficos PNG desde un CSV de benchmarks en outputs/plots/"""
    ...
    graficar_heatmap_elementos_global(ruta_csv)
